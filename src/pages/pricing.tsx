      ...
      <div className="flex gap-6 mt-6">
        ...
        <div className="p-6 border rounded-lg bg-white shadow-lg">
          ...
          <button
            onClick={() =>
              handleCheckout(
                'basic_monthly',
                process.env.NEXT_PUBLIC_STRIPE_BASIC_MONTHLY!
              )
            }
            className="mt-3 px-4 py-2 bg-blue-600 text-white rounded-lg"
            disabled={
              loadingPlan === process.env.NEXT_PUBLIC_STRIPE_BASIC_MONTHLY
            }
          >
            {loadingPlan === process.env.NEXT_PUBLIC_STRIPE_BASIC_MONTHLY
              ? 'Processing...'
        ...
        <div className="p-6 border rounded-lg bg-white shadow-lg">
          ...
          <button
            ...
            disabled={
              loadingPlan === process.env.NEXT_PUBLIC_STRIPE_PRO_MONTHLY
            }
          >
            {loadingPlan === process.env.NEXT_PUBLIC_STRIPE_PRO_MONTHLY
              ? 'Processing...'
